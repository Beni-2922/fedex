...
<body>
  ...
  <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <img src="img/Brand_850415_US_Support_hero_v1_413382890.jpg" class="d-block w-100" alt="Sunset Over the City" />
      ...
      <div class="carousel-item">
        <img src="img/201504_15_002_01_01_03_072_dm_160125_539799568.jpg" class="d-block w-100" alt="Canyon at Nigh" />
        <div class="carousel-caption d-none d-md-block">
          <h1>Servicio al cliente</h1>
        </div>
      </div>
  ...
  <div class="container row principal">
    <div class="card tarjetas" style="width: 18rem;">
      <img src="img/1.-PhotoRoom.png-PhotoRoom.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Contactar a FedEx en línea</h5>
        <p class="card-text">Nuestros representantes están disponibles en línea de lunes a viernes, de 08:30 a 17:00 h,
          excepto días festivos.</p>
        <a href="#" class="btn btn-primary rounded-pill">ESCRIBIR A FEDEX</a>
      </div>
    </div>
    <div class="card tarjetas" style="width: 18rem;">
      <img src="img/2-PhotoRoom.png-PhotoRoom.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Comunicarse con FedEx por teléfono </h5>
        <p class="card-text">El departamento de Servicio al Cliente está disponible: de lunes a viernes desde las 7:00
          hasta las 21:00 horas. Sábados desde las 8:00 hasta las 16:00 horas. Domingos desde las 9:00 hasta las 15:30
          horas.
        </p>
      </div>
    </div>
    <div class="card tarjetas" style="width: 18rem;">
      <img src="img/3-PhotoRoom.png-PhotoRoom.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Servicio de apoyo tecnológico al cliente</h5>
        <p class="card-text">Para obtener ayuda con fedex.com o FedEx Ship Manager™, llama al 55.5228.9904:
        <ul class="puntos">
          <li>
            Seleccionar idioma
          </li>
          <li>Presione 7 para más servicios
          </li>
          <li> Presione 6 para Asistencia Técnica</li>
        </ul>
        <p>Llame hoy; un especialista lo ayudará a aclarar sus dudas y preguntas.
        </p>
        </p>
      </div>
    </div>
    <div class="card tarjetas" style="width: 18rem;">
      <img src="img/Dark_Gray_Empty_Packaging_Icon_-_Large.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">¡Invítanos a participar! </h5>
        <p class="card-text">Invítanos e infórmanos sobre tu licitación de proveedores, por favor completa el formulario
          a continuación.</p>
        <a href="#" class="btn btn-primary rounded-pill">COMPLETA EL FORMULARIO.</a>
      </div>
    </div>
  </div>
  <br>
  ...
  <main class="nuevaseccion">
    <div class="container text-center">
      <div class="row align-items-start">
        <div class="col">
          <img src="img/LAC_EN_2021_7_master_jpg_FOC-portal-faq_cus.jpg" style="width: 450px;" style="height: 450px;">
        </div>
        <div class="col">
          <h3 class="title">¡Pagar tus facturas de FedEx es fácil!</h3>
          <div class="row justify-content-center">
            Elige la opción de pago en línea que mejor se ajuste a tus necesidades.
          </div>
          <br>
