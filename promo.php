...
<body>
  ...
  <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <img src="img/MX_EN_2023_1_jpg_NA_UEFA_HeroBanner_mkt.png" class="d-block w-100" alt="Sunset Over the City" />
        <div class="carousel-caption d-none d-md-block">
          <h1 class="uefa">Envía como campeón con FedEx</h1>
        </div>
      </div>

      <!-- Single item -->
      <div class="carousel-item">
        <img src="img/MX_EN_2023_1_jpg_NA_UEFA_HeroBanner_mkt.png" class="d-block w-100" alt="Canyon at Nigh" />
        <div class="carousel-caption d-none d-md-block">
          <h1 class="uefa1">FedEx</h1>
        </div>
      </div>
  ...
  <h2 class="container text-center Champions">FedEx te lleva a la final de la UEFA Champions League 2023 en Estambul,
    Turquía </h2>

  <div class="container">
    <div class="card cards animate__animated animate__fadeIn">
      <div class="number1">1</div>
      <div class="text">Realiza un envío nacional o internacional con FedEx durante el periodo de la promoción.</div>
    </div>
    <div class="card cards animate__animated animate__fadeIn">
      <div class="number2">2</div>
      <div class="text">Registra tu información y número guía.</div>
    </div>
    <div class="card cards animate__animated animate__fadeIn">
      <div class="number3">3</div>
      <div class="text">Contesta de manera correcta la trivia de 20 preguntas.</div>
    </div>
    <div class="card cards animate__animated animate__fadeIn">
      <div class="number4">4</div>
      <div class="text">Los ganadores serán quienes hayan contestado la trivia de manera correcta en el menor tiempo
        posible.
      </div>
    </div>
  </div>
  <div class="text-center">
    <a
      href="https://www.fedex.com/content/dam/fedex/lac-latin-america/downloads/2023/MX_ES_2023_2_pdf_NA_TC-UEFA-Champions_mkt.pdf">
      <button class="btn btn-outline-primary btn-rounded animate__animated animate__zoomIn consulta">Consulta términos y
        <br> condiciones aquí.</button>
    </a>
  </div>
  <div class="container">
    <span class="btnpromo">Solo pueden participar en la promoción personas físicas y jurídicas que posean microempresas
      y pequeñas o medianas empresas. Esta promoción no se aplica a dueños de centros autorizados de envíos FedEx (FASC)
      o distribuidores no autorizados, personas que hayan ganado una promoción o un concurso de FedEx dentro de los
      últimos 5 años, familiares hasta el tercer grado de parentesco de cualquier miembro de FedEx ni cazadores de
      ofertas.</span>
  </div>
